...
//	}
	...
	public void saveCustomer(Customer customer) {
		mongoUtils.saveDocument(customer);
	}
	
	@Override
	public Customer findByEmail(String email) {
//		mongoUtils.findOne(_id, id, clazz);
		List<Customer> listCustomer = new ArrayList<Customer>();
		try {
            // Truy vấn dữ liệu từ MongoDB
            listCustomer = mongoUtils.findItemByField("email", email, Customer.class);
...
//	}
	...
	@Override
	public void updateCustomer(String documentId, Map<String, ? extends Object> dataToSave) {
		mongoUtils.updateDocumentById(documentId, dataToSave,Customer.class);
	};
